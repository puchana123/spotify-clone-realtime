            ...
            <ScrollArea className="flex-1">
                <div className="p-4 space-y-4">
                    {users.map((user) => {
                        ...
                        console.log("🎵 Current user activities in state:", Array.from(userActivities.entries()));
                        return (
...
const LoginPrompt = () => (
    <div className="h-full flex flex-col items-center justify-center p-6 text-center space-y-4">
        ...
        <div className="space-y-2 max-w-[250px]">
            ...
            <p className="text-sm text-zinc-400">Log in to discover what music your friends are enjoying right now</p>
        </div>
    </div>
)